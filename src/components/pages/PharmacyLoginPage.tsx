  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email && password.length >= 6) {
        ...
        localStorage.setItem('pharmacySession', JSON.stringify({ email, timestamp: Date.now() }));
          ...
          <div className="bg-light-grey p-12">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="pharmacy-email" className="font-paragraph text-base">
                  Email Address
                </Label>
                <Input
                  id="pharmacy-email"
              ...
              <div className="space-y-2">
                <Label htmlFor="pharmacy-password" className="font-paragraph text-base">
                  Password
                </Label>
            ...
            <div className="mt-8 pt-8 border-t border-medium-grey">
              ...
              <div className="bg-background p-4 space-y-2">
                <p className="font-paragraph text-sm text-foreground">
                  <span className="font-medium">Email:</span> pharmacy@example.com
                </p>
                <p className="font-paragraph text-sm text-foreground">
